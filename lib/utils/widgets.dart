...
// Lista de colores que aparecen en pantalla de agregar una nota nueva
List<Color> colors = [
...
// Estado del selector de prioridad
class _PriorityPickerState extends State<PriorityPicker> {
  int selectedIndex;
  List<String> priorityText = ['Chico', 'Mediano', 'Grande'];
